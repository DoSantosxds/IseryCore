...
//	public static final String CHAT_ATTEMPT_FILTERED = "&6Your message was filtered.";
//	public static final String CHAT_ATTEMPT_PLAYER_MUTED = "&6You are currently muted for another {time-remaining}.";
//	public static final String CHAT_ATTEMPT_PUBLIC_CHAT_MUTED = "&6The public chat is currently muted.";
//	public static final String CHAT_ATTEMPT_PUBLIC_CHAT_DELAYED = "&6You may chat again in {time-remaining}.";
//	public static final String OPTIONS_GLOBAL_CHAT_DISABLED = "&6You have your public chat disabled.";
//	public static final String OPTIONS_PRIVATE_CHAT_DISABLED = "&6You have your private messages disabled.";
//	public static final String PTIONS_PRIVATE_CHAT_DISABLED_OTHER = "&6That player has their private messages disabled.";
