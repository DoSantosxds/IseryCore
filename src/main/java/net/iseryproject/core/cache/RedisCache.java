package net.iseryproject.core.cache;
...
public class RedisCache {
	...
	public UUID getUuid(String name) {
		...
		try (Jedis jedis = core.getJedisPool().getResource()) {
			if (core.getMainConfig().getBoolean("REDIS.AUTHENTICATION.ENABLED")) {
				jedis.auth(core.getMainConfig().getString("REDIS.AUTHENTICATION.PASSWORD"));
			}
