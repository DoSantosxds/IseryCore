...
public class ConfigConversion3 implements ConfigConversion {
    ...
    public void convert(File file, FileConfiguration fileConfiguration) {
        ...
        fileConfiguration.set("OPTIONS.GLOBAL_CHAT_DISABLED", "&6You will no longer see global chat.");
        fileConfiguration.set("OPTIONS.PRIVATE_MESSAGES_ENABLED", "&aYou can now receive new conversations.");
        fileConfiguration.set("OPTIONS.PRIVATE_MESSAGES_DISABLED", "&6You can no longer receive new conversations. If you start a conversation with a player, they will be able to message you back.");
        fileConfiguration.set("OPTIONS.PRIVATE_MESSAGE_SOUNDS_ENABLED", "&eYou enabled private message sounds.");
        fileConfiguration.set("OPTIONS.PRIVATE_MESSAGE_SOUNDS_DISABLED", "&6You disabled private message sounds.");
