package net.iseryproject.core.profile.grant.menu;
...
import net.iseryproject.core.util.menu.pagination.PaginatedMenu;
		...
		public ItemStack getButtonItem(Player player) {
			...
			if (grant.isRemoved()) {
				...
				if (!grant.hasExpired()) {
					...
					if (player.hasPermission("core.grants.remove")) {
						lore.add("&aRight click to remove this grant");
					} else {
						lore.add("&6You cannot remove grants");
					}
				}
			}
