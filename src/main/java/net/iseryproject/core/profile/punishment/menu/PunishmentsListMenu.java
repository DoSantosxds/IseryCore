package net.iseryproject.core.profile.punishment.menu;
...
import net.iseryproject.core.cache.RedisPlayerData;
import net.iseryproject.core.profile.Profile;
import net.iseryproject.core.profile.menu.ProfileMenuControlHeaderButton;
import net.iseryproject.core.profile.punishment.Punishment;
import net.iseryproject.core.profile.punishment.PunishmentType;
import net.iseryproject.core.profile.punishment.procedure.PunishmentProcedure;
import net.iseryproject.core.util.CC;
import net.iseryproject.core.util.ItemBuilder;
import net.iseryproject.core.util.TimeUtil;
import net.iseryproject.core.util.menu.Button;
import net.iseryproject.core.util.menu.pagination.FilterablePaginatedMenu;
import net.iseryproject.core.util.menu.pagination.PageFilter;
...
public class PunishmentsListMenu extends FilterablePaginatedMenu<Punishment> {
	...
	public String getPrePaginatedTitle(Player player) {
		return "&6" + profile.getName() + "'s Punishments (" + getCountOfFilteredPunishments() + ")";
	}
