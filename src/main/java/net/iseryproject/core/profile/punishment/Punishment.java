package net.iseryproject.core.profile.punishment;

import lombok.Getter;
import lombok.Setter;
import network.katana.core.Core;
import network.katana.core.util.CC;
import network.katana.core.util.TimeUtil;
import org.bukkit.*;
...
public class Punishment {
	...
	public String getKickMessage() {
		...
		if (type == PunishmentType.BAN) {
			...
			kickMessage = Core.get().getMainConfig().getString("PUNISHMENTS.BLACKLIST.KICK");
		} else {
			kickMessage = null;
		}
